...
double precision, dimension(:,:), allocatable :: d_matrix
...
integer :: ns, no, nor, n_spur,n_spur_ind
integer :: info,lwork
double precision :: xe 
...
open(9,file='egv_h1phon.dat',status='unknown',form='formatted')
...
call odd_phonbase(nf,ipar,ijj,it_bs,dim_phon,lev,phon,isp_min,isp_max,hol_lev,dim_base,dim_baser,phonbs,ind_red,n_spur)


write(*,*)'Dimension of space =',dim_base
write(*,*)'Dimension of Tz= ',it_bs,' subspace  =',dim_baser

CALL execute_command_line('./run_admat_h1ph.sh' )
