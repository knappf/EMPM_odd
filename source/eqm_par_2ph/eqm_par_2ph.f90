...
nlam=0
namex='2phon_part/2f_x.dat'
namec='2phon_part/2f_c.dat'
names='2phon_part/2f_states.dat'
...
do i=1,dim_baser
 do j=i,dim_baser
   if (dabs(ham(i,j)-ham(j,i)).gt.0.0001d0) write(*,'(2i5,f10.5)')'AD asymm.',i,j,dabs(ham(i,j)-ham(j,i))
 enddo
enddo
...
enddo
      ...
      enddo
       ...
       open(9,file='egv.dat',status='unknown',form='formatted')
        write(9,*)' Parity = ',ipar, ' 2*J = ',ijj, ' Tz =',it_bs
        write(9,*)
