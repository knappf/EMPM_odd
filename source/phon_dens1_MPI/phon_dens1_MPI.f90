!     
!     Program phon_dens1 computes 1phonon densities in Tz J-coupled formalism.
!     last update 12.5.2023

      program phon_dens1_MPI
...
!      write(*,*)xthres  
      xthres=100000000.0
      call rop(ifmx,nlev,jmax,lev,xthres,ih_lev,ip_lev,par_lev,hol_lev,myid,numprocs)

      call MPI_BARRIER(  MPI_COMM_WORLD, ierr)
      
      call roh(ifmx,nlev,jmax,lev,xthres,ih_lev,ip_lev,par_lev,hol_lev,myid,numprocs)
